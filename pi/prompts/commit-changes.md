...
# /commit-changes — Structured local commits (no push)
...
* `/commit-changes` → commit **all uncommitted changes**
* `/commit-changes <paths...>` → commit **only changes inside those paths**
